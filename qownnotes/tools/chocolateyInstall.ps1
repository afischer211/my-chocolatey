...
$url            = 'https://github.com/pbek/QOwnNotes/releases/download/windows-b5736/QOwnNotes.zip' 
$checksum       = 'E0754B00A67AD1AC7721D63417B909D0EE536DCB96E159F5A4884B2031B8A691'
$url64          = $url
$checksum64     = $checksum
$checksumType   = 'sha256' 
