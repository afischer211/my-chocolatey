...
$url            = 'https://github.com/pbek/QOwnNotes/releases/download/windows-b5718/QOwnNotes.zip' 
$checksum       = '63437731DFA3276B65F9DB9B77BB9C7615C75DB2189446717FCE04246CA82D1A'
$url64          = $url
$checksum64     = $checksum
$checksumType   = 'sha256' 
