...
$url            = 'https://github.com/pbek/QOwnNotes/releases/download/windows-b5767/QOwnNotes.zip' 
$checksum       = '16654AEB43FB8B66DD336B108796D1AAF6E7DE6255F25F7D92CD40CA9898B78E'
$url64          = $url
$checksum64     = $checksum
$checksumType   = 'sha256' 
