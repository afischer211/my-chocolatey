...
$url            = 'https://github.com/pbek/QOwnNotes/releases/download/windows-b5746/QOwnNotes.zip' 
$checksum       = '0939B3378DABF117FA5A629C3ECADE7AA30DC031BAA822243DC89D89E089437E'
$url64          = $url
$checksum64     = $checksum
$checksumType   = 'sha256' 
